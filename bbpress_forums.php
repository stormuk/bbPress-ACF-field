...
/*
 * Advanced Custom Fields - bbPress Forums Multi-Select Field add-on
 *
 *
 * Contributors: by @adam_pope of @stormuk
 *
 * Tags: acf, acf add-on, forums, bbPress, custom field, forum field
...
class bbPress_forums_field extends acf_Field
{
  ...
  *-------------------------------------------------------------------------------------*/
  ...
  function __construct($parent)
  {
    // do not delete!
      ...
      // set name / title
      $this->name = 'bbpress_forums_field'; // variable name (no spaces / special characters / etc)
    $this->title = __("bbPress Forums",'acf'); // field label (Displayed in edit screens)
